            ...
            >
              ...
              >
                ...
                <CardHeader className="relative z-10">
                  <motion.div 
                    className={cn(
                      "rounded-2xl w-16 h-16 flex items-center justify-center mb-4",
                  ...
                  <CardTitle className="text-xl bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">
                    {feature.title}
                  </CardTitle>
                </CardHeader>
